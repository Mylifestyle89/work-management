    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          className="rounded-lg border border-slate-200/70 bg-white px-4 py-2 text-xs font-semibold text-slate-600 shadow-sm transition-all hover:shadow-md dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
        >
          Lịch sử công việc
        </button>
        <button
